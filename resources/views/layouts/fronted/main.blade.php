...
<head>
    ...
    <link href='//fonts.googleapis.com/css2?family={{$style->font_head}}:wght@700&display=swap' rel='stylesheet'
          type='text/css'>
    <link href='//fonts.googleapis.com/css2?family={{$style->font_main}}:wght@400;700&display=swap' rel='stylesheet'
          type='text/css'>
    ...
    @if( !empty($general->image_favicon))
        ...
        <link rel="apple-touch-icon-precomposed" sizes="152x152"
              href="{{ asset('uploads/img/general/favicon/apple-touch-icon-152x152-precomposed.png') }}">
        <link rel="apple-touch-icon-precomposed" sizes="144x144"
              href="{{ asset('uploads/img/general/favicon/apple-touch-icon-144x144-precomposed.png') }}">
        <link rel="apple-touch-icon-precomposed" sizes="120x120"
              href="{{ asset('uploads/img/general/favicon/apple-touch-icon-120×120-precomposed.png') }}	">
        <link rel="apple-touch-icon-precomposed" sizes="114x114"
              href="{{ asset('uploads/img/general/favicon/apple-touch-icon-114x114-precomposed.png') }}">
        <link rel="apple-touch-icon-precomposed" sizes="76x76"
              href="{{ asset('uploads/img/general/favicon/apple-touch-icon-76×76-precomposed.png') }}	">
        <link rel="apple-touch-icon-precomposed" sizes="72x72"
              href="{{ asset('uploads/img/general/favicon/apple-touch-icon-72x72-precomposed.png') }}">
        <link rel="apple-touch-icon-precomposed" sizes="57x57"
              href="{{ asset('uploads/img/general/favicon/apple-touch-icon-57x57-precomposed.png') }}">
        <link rel="shortcut icon" href="{{ asset('uploads/img/general/favicon/favicon.png') }}">
    @endif

</head>
<body class="@if($general->loader == 1){{'preloader'}}@endif @if($blog_active == 1){{'blog_active'}}@endif"
      data-blog="{{$blog_active}}">
