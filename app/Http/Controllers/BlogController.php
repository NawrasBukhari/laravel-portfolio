        ...
        if (! empty($data)) {
            ...
            if ($validate_1->fails()) {
                ...
                if ($validate_2 != null && $validate_2->fails()) {
                    ...
                    if ($data['type'] == 'standard') {
                        $directory = 'public/uploads/img/blog';
                    ...
                    foreach ($source as $file) {
                        copy($file, 'public/uploads/img/blog/'.substr($file, 17));
                        unlink($file);
                    }
                    $post = new Blog();
                    $post->title = $data['title'];
                    $post->short_desc = $data['short_desc'];
                    $post->text = str_replace('public/uploads/img/temp', 'public/uploads/img/blog', $data['text']);
                    $post->type = $data['type'];
            ...
            if ($validate_1->fails()) {
                ...
                if ($validate_2 != null && $validate_2->fails()) {
                    ...
                    $data_new = [
                        ...
                        'text' => str_replace('public/uploads/img/temp', 'public/uploads/img/blog', $data['text']),
                        'type' => $data['type'],
                        'image' => $route_image,
                        'video' => $video,
