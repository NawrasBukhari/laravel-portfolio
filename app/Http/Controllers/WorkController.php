...
class WorkController extends Controller
{
        ...
        if (! empty($data)) {
            ...
            if ($validate_1->fails()) {
                ...
                if ($validate_2 != null && $validate_2->fails()) {
                    ...
                    $directory = 'public/uploads/img/work';
                    ...
                    $source = glob('public/uploads/img/temp/*');
                    foreach ($source as $file) {
                        copy($file, 'public/uploads/img/work/'.substr($file, 17));
                        unlink($file);
                    }
                    ...
                    $project->description = str_replace('public/uploads/img/temp', 'public/uploads/img/work', $data['description']);
            ...
            if ($validate_1->fails()) {
                ...
                if ($validate_2 != null && $validate_2->fails()) {
                    ...
                    $data_new = [
                        ...
                        'description' => str_replace('public/uploads/img/temp', 'public/uploads/img/work', $data['description']),
                        'image' => $route_image,
    ...
    public function destroy($id, Request $request)
    {
        ...
        if (! empty($validate)) {
            $source = glob('public/uploads/img/work/*');
            foreach ($source as $file) {
